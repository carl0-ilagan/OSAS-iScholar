...
function parseServiceAccount() {
  ...
  // Note: On Vercel/Netlify/Railway, a relative path like ./key.json usually fails unless that file
  // is actually in the deployed bundle. Prefer FIREBASE_SERVICE_ACCOUNT_JSON or *_PROJECT_ID/_EMAIL/_KEY.
  const pathFromEnv =
